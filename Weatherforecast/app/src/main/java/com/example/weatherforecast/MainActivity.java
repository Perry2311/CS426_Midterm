...
public class MainActivity extends AppCompatActivity {
    ...
    String CITY;
    String API = "22de7a243950349ac3f822b7f06b2cb1";
    ImageView search;
    EditText etCity;
    ...
    class weatherTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... args) {
            String response = HttpRequest.excuteGet("https://api.openweathermap.org/data/2.5/weather?q=" + CITY + "&units=metric&appid=22de7a243950349ac3f822b7f06b2cb1");
            return response;
        }
